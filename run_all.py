...
def main() -> None:
    ...
    ap.add_argument("--model", default=None, help="Model LLM (Phase 3), default gpt-4o-mini")
    ...
    for p in order:
        ...
        if p == "3" and args.model:
            kwargs["model"] = args.model
        if p == "3" and args.only_batch is not None:
            kwargs["only_batch"] = args.only_batch
        if p == "3" and args.force:
            kwargs["force"] = True
